...
conda activate base && conda env remove -n mamba-showo --yes
conda create -n mamba-showo python=3.10 --yes
conda activate mamba-showo
pip install jupyter
pip install torch==2.5.0 torchvision==0.20.0 torchaudio==2.5.0 --index-url https://download.pytorch.org/whl/cu118
pip install mamba-ssm==2.2.2 transformers==4.46.2 diffusers==0.31.0 omegaconf==2.3.0 jaxtyping==0.2.34 wandb==0.18.7
pip install python-dotenv
pip install accelerate lightning scipy webdataset datasets
pip install deepspeed matplotlib
## Getting Started
